...
- 椭圆锥面：$\frac{x^{2}}{a^{2}}+\frac{y^{2}}{b^{2}}=z^{2}$ **有正有负=0**
- 椭球面：$\frac{x^{2}}{a^{2}}+\frac{y^{2}}{b^{2}}+\frac{z^{2}}{c^{2}}=1$  **全正** 
- 单页双页面：$\frac{x^{2}}{a^{2}}+\frac{y^{2}}{b^{2}}-\frac{z^{2}}{c^{2}}=1$ **两正一负**
- 双叶双曲面：$\frac{x^{2}}{a^{2}}-\frac{y^{2}}{b^{2}}-\frac{z^{2}}{c^{2}}=1$ **一正两负** 
- 椭圆双曲面：$\frac{x^{2}}{a^{2}}+\frac{y^{2}}{b^{2}}=z$ **俩正二次 一个一次** 
- 双曲抛物面：$\frac{x^{2}}{a^{2}}-\frac{y^{2}}{b^{2}}=z$ **一正一负 一个一次** 
...
由基A变到基B：$B=PA$，由坐标X(A)变到坐标Y(B)：$X=PY$，使用逆运算即可求解处过渡矩阵。
...
$W_3$和$W_4$仍是V的子空间，但是$W_1\cup W_2=W_5$不一定是子空间。  
...
\end{vmatrix}
=
\prod_{1 \le i \lt j \le n}{(m_j-m_i)}
$$
